...
\begin{figure}[ht]
  ...
  \caption{Comparação de estratégias de validação cruzada. Correlação constante, $\rho=0.5,\ p=2000,\ k^\dagger=100,\ \text{SNR}=10$.}
...
\begin{figure}[ht]
  ...
  \caption{Comparação de estratégias de validação cruzada. Correlação constante, $\rho=0.9,\ p=1000,\ k^\dagger=20,\ \text{SNR}=5$.}
...
\begin{figure}[ht]
  ...
  \caption{Comparação de estratégias de validação cruzada. Correlação exponencial, $\rho=0.9,\ p=1000,\ k^\dagger=20,\ \text{SNR}=5$.}
...
\begin{figure}[ht]
  ...
  \subbottom[Similaridade do Suporte.]{%
    \includegraphics[width=0.45\linewidth]{\mixedPath const-0.5-2000/pnSim-VariableN_L0_const-0.5-2000-10.0-100-10-200_200_2000_false.png}}
  \subbottom[Tempo de execução (s).]{%
    \includegraphics[width=0.45\linewidth]{\mixedPath const-0.5-2000/pnTime-VariableN_L0_const-0.5-2000-10.0-100-10-200_200_2000_false.png}}\\
  \subbottom[Erro Máximo nos Parâmetros ($L_\infty$).]{%
    \includegraphics[width=0.45\linewidth]{\mixedPath const-0.5-2000/pnInf-VariableN_L0_const-0.5-2000-10.0-100-10-200_200_2000_false.png}}
  \caption{Comparação com o L0Learn. Correlação constante, $\rho=0.5,\ p=2000,\ k^\dagger=100,\ \text{SNR}=10$.}
...
\begin{figure}[ht]
  ...
  \caption{Comparação com o L0Learn. Correlação exponencial, $\rho=0.9,\ p=1000,\ k^\dagger=20,\ \text{SNR}=5$.}
  \label{fig:l0learn_anexo_3}
\end{figure}
\chapter{Análise do refinamento}
\label{chap:anexos_refinement}

Neste apêndice, detalhamos o impacto do refinamento final na qualidade da solução. Os gráficos abaixo evidenciam, para cada método e cenário, ``Choices'', a frequência com que o candidato a partir do zero (\textit{zero-based}) foi escolhido em detrimento do candidato do caminho (\textit{path-based}), ``Wins'' (melhora no suporte) e ``Losses'' (piora no suporte) na similaridade quando o zero é escolhido, e o impacto dessa escolha na similaridade do suporte (``Sim Improv''), também condicionado à escolha pelo zero.

\begin{figure}[ht]
  \centering
  \subbottom[NSPG+CPSI1: Refinamento.]{%
    \includegraphics[width=0.49\linewidth]{\cvPath SPG/exp-0.5-2000/Comp_Refinement-NSPG+CPSI1_Comparison_exp-0.5-2000.png}}
  \subbottom[L0Learn+CPSI1: Refinamento.]{%
  ...
  \subbottom[NSPG+PGCCD+CPSI1: Refinamento.]{%
...
\chapter{Comparação com Estrutura Tridiagonal em Blocos}
\label{chap:anexos_tri}

Neste apêndice, apresentamos os resultados complementares dos experimentos tridiagonais em bloco. As Figuras \ref{fig:tri_anexo_1} e \ref{fig:tri_anexo_2} detalham os cenários com correlação inicial reduzida ($\rho=0.5$) e maior relação sinal-ruído ($\text{SNR}=10$).

\begin{figure}[H]
  \centering
  \subbottom[Similaridade do Suporte.]{%
    \includegraphics[width=0.45\linewidth]{images/Mixed_v2/Tridiagonal/const-0.5-2000/pnSim-NewTerminal_mixed_v2_tri_const_0.5_p2000.png}}
  \subbottom[Tempo de execução (s).]{%
    \includegraphics[width=0.45\linewidth]{images/Mixed_v2/Tridiagonal/const-0.5-2000/pnTime-NewTerminal_mixed_v2_tri_const_0.5_p2000.png}}\\
  \subbottom[Erro Máximo nos Parâmetros ($L_\infty$).]{%
    \includegraphics[width=0.45\linewidth]{images/Mixed_v2/Tridiagonal/const-0.5-2000/pnInf-NewTerminal_mixed_v2_tri_const_0.5_p2000.png}}
  \caption{Experimento tridiagonal. Correlação constante, $\rho=0.5,\ p=2000,\ k^\dagger=100,\ \text{SNR}=10$.}
  \label{fig:tri_anexo_1}
\end{figure}

\begin{figure}[H]
  \centering
  \subbottom[Similaridade do Suporte.]{%
    \includegraphics[width=0.45\linewidth]{images/Mixed_v2/Tridiagonal/exp-0.5-2000/pnSim-NewTerminal_mixed_v2_tri_exp_0.5_p2000.png}}
  \subbottom[Tempo de execução (s).]{%
    \includegraphics[width=0.45\linewidth]{images/Mixed_v2/Tridiagonal/exp-0.5-2000/pnTime-NewTerminal_mixed_v2_tri_exp_0.5_p2000.png}}\\
  \subbottom[Erro Máximo nos Parâmetros ($L_\infty$).]{%
    \includegraphics[width=0.45\linewidth]{images/Mixed_v2/Tridiagonal/exp-0.5-2000/pnInf-NewTerminal_mixed_v2_tri_exp_0.5_p2000.png}}
  \caption{Experimento tridiagonal. Correlação exponencial, $\rho=0.5,\ p=2000,\ k^\dagger=100,\ \text{SNR}=10$.}
  \label{fig:tri_anexo_2}
\end{figure}
