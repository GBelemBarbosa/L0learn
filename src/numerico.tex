...
\begin{figure}[H]
  ...
  \subbottom[\label{cv_spg}SPG: Comparação de CVs.]{%
    \includegraphics[width=0.32\linewidth]{images/Comp_Sim-SPG_Comparison_exp-0.5-2000-10.0-100.png}}
  \subbottom[\label{cv_cdss}CDSS: Comparação de CVs.]{%
    \includegraphics[width=0.32\linewidth]{images/Comp_Sim-CDSS_Comparison_exp-0.5-2000-10.0-100.png}}
  \subbottom[\label{cv_spgpcdss}SPG+CDSS: Comparação de CVs.]{%
    \includegraphics[width=0.32\linewidth]{images/Comp_Sim-SPGpCDSS_Comparison_exp-0.5-2000-10.0-100.png}}
