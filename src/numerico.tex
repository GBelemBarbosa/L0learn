...
\begin{figure}[ht]
  ...
  \subbottom[\label{cv_spg}SPG: Comparação de CVs.]{%
    \includegraphics[width=0.45\linewidth]{images/Comp_Sim-SPG-exp-0.5.png}}
   \subbottom[\label{cv_cdss}CDSS: Comparação de CVs.]{%
    \includegraphics[width=0.45\linewidth]{images/Comp_Sim-CDSS-exp-0.5.png}}
