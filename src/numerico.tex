...
Nesse experimento, visamos identificar o efeito que cada algoritmo tem quando empregado como \textit{inner solver} do algoritmo CPSI1 (\autoref{alg:cpsi}). Serão testados o PGCCD, o NSPG e o NSPG seguido do PGCCD. Como comparação da qualidade das soluções, também foi incluído o NSPG sem estratégia combinatorial.
