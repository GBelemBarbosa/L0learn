...
Já se tomarmos $h(x)\coloneqq \lambda_0 \|x\|_0 + \lambda_1 \|x\|_1+\lambda_2 \|x\|_2^2$ (termo quadrático como parte da regularização), o operador proximal se torna
\begin{equation}\label{eq:proxl0l1l2}
\left[\prox_{ch}(x)\right]_i=\argmin_{u_i\in\R}h_i(u_i)=\begin{cases}
